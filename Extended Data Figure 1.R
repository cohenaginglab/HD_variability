...
tiff("Extended Data_Figure_1.tiff", width = 180, height = 180, "mm", res = 300, compression = "lzw")
...
write.csv(res_2wks, "ExtDatFigure1_panelsA_B.csv", row.names = F)
...
write.csv(res_all, "ExtDatFigure1_panelC.csv", row.names = F)
