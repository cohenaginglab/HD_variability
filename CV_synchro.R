#######################################################################################################
#####       This code is for the figure entitled "Physiological variability shows a strong        ##### 
#####            coordinated signal distributed evenly across all measured biomarkers"            #####
#######################################################################################################
library(ggplot2)
library(ggpubr)
...
####### Save Figure ########
tiff("CV synchro.tiff", 210, 150, "mm", res = 600, compression = "lzw", bg = "transparent")
