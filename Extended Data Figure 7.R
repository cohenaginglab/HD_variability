...
tiff("ExtDatFigure_7.tiff", width = 180, height = 180, "mm", res = 300, compression = "lzw")
...
write.csv(res_2wks, "ExtDatFigure_7_panelsA_B.csv", row.names = F)
...
write.csv(res_all, "ExtDatFigure_7_panelC.csv", row.names = F)
