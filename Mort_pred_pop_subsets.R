#######################################################################################################
#####          This code is for the figure entitled "Mortality prediction by PC1, PC2,            ##### 
#####                    PC6, CVPC1, and CVPC3 in different population subsets"                   #####
#######################################################################################################
...
write.csv(res_all, "Mort_pred_pop_subsets.csv", row.names = F)

#### Plot results #####
tiff("Mort_pred_pop_subsets.tiff", width = 180, height = 240, "mm", res = 300, compression = "lzw")
