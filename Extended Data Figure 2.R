...
tiff("Extended Data_Figure_2.tiff", width = 180, height = 180, "mm", res = 300, compression = "lzw")
...
write.csv(res_2wks, "ExtDatFigure2_panelsA_B.csv", row.names = F)
...
write.csv(res_all, "ExtDatFigure2_panelC.csv", row.names = F)
