...
tiff("ExtDatFigure_5.tiff", width = 180, height = 180, "mm", res = 300, compression = "lzw")
...
write.csv(res_2wks, "ExtDatFigure_5_panelsA_B.csv", row.names = F)
...
write.csv(res_all, "ExtDatFigure_5_panelC.csv", row.names = F)
