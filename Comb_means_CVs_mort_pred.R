#######################################################################################################
#####          This code is for the figure entitled "Effect of combining biomarker means          ##### 
#####               and CVs on prediction of mortality for PC1, PC2, PC6, and CVPC3"              #####
#######################################################################################################
...
write.csv(res, "Comb_means_CVs_mort_pred.csv", row.names = F)

#### Plot
tiff("Comb_means_CVs_mort_pred.tiff", width = 180, height = 270, "mm", res = 300, compression = "lzw")
