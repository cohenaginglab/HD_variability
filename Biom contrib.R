#######################################################################################################
#####          This code is for the figure entitled "Relative biomarker contributions to          ##### 
#####                    PC1, PC2, PC6, and CVPC3 for the 2-week variable list"                   #####
#######################################################################################################
library(ggplot2)
library(ggpubr)
...
vars.nms <- c("WBC", "Hemoglobin", "Hematocrit", "MCH", "MCHC", "MCV", "Platelets", "RDW", "Potassium", 
              "Sodium", "RBC")
...
##### Plot
tiff("Biom contrib.tiff", 220, 180, "mm", res = 600, compression = "lzw")
