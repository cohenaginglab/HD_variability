#######################################################################################################
#####                 This code is for the figure entitled "Prediction of death by                ##### 
#####                          biomarker levels and variability indices"                          #####
#######################################################################################################
...
tiff("Mort_pred.tiff", width = 180, height = 180, "mm", res = 300, compression = "lzw")
...
write.csv(res_2wks, "Mort_pred_panelsA_B.csv", row.names = F)
...
write.csv(res_all, "Mort_pred_panelC.csv", row.names = F)
