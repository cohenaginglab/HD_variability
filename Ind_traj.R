#######################################################################################################
#####             This code is for the figure entitled "Individual CVPC1 trajectories             ##### 
#####                                  before death or censoring"                                 #####
#######################################################################################################
library(ggplot2)
library(ggpubr)
...
tiff("Ind_traj.tiff", 200, 120, "mm", res = 600, compression = "lzw", bg = "transparent")
