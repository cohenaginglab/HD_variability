#######################################################################################################
#####        This code is for the figure entitled "Mortality prediction by PC1, PC2, PC7,         ##### 
#####       CVPC1, and CVPC3 in different population subsets for the 4-month variable list"       #####
#######################################################################################################
...
write.csv(res_all, "Mort_pred_pop_subsets_4mth.csv", row.names = F)

#### Plot results #####
tiff("Mort_pred_pop_subsets_4mth.tiff", width = 180, height = 240, "mm", res = 300, compression = "lzw")
